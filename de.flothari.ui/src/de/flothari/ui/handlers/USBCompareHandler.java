...
public class USBCompareHandler
{

	@Inject
	private LocalFileCameraService cameraService; // capture Pfad
	@Inject
	private OpenCvRecognitionService recognition; // OpenCvRecognitionService
	@Inject
	private InMemoryInventoryService inventory; // InMemoryInventoryService (später SQLite)
	@Inject
	...
	public void execute()
	{
		Thread worker = new Thread(() ->
		{
			try
			{
				...
				Path captureFile = cameraService.capture();
